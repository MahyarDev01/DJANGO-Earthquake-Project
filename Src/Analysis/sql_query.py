...
def task11_region_analysis():
    ...
    # گروه بندی داده ها بر اساس region  و محاسبه ی :
    #-تعداد زلزله ها
    #-میانگین بزرگی
    #-میانگین عمق
    #-کمترین و بیشترین بزرگی
    #-کمترین و بیشترین عمق 
...
def task12_region_month_category_analysis():
    ...
    #گروه بندی بر اساس region,month,category و محاسبه ی: 
    #تعداد زلزله
    #میانگین بزرگی
    #میانگین عمق
...
def task13_top_10_recent_strong_earthquakes():
   # نمایش ۱۰ زلزله ی شدی اخیر بر حسب بزرگی بیش از ۶
...
def task14_dangerous_earthquakes():
    ...
    # زلزله هایی که بزرگی آنها بیش تر از ۶ و عمق آنها کمتر از ۵۰ کیلومتر است.
...
def task16_average_magnitude_by_region_source():
    ...
    # میانگین بزرگی زلزله ها به تفکیک region , source.   نمایش نتیجه به ترتیب بیشترین میانگین
...
def task17_create_indexes():
    # ساخت ایندکس برای ستون های region,time,magnitude
